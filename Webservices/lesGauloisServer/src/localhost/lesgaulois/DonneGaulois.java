 ...
 */
            ...
            /**
            *  DonneGaulois bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DonneGaulois
    ...
    public static class Factory{
        ...
        */
        public static DonneGaulois parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DonneGaulois object =
                new DonneGaulois();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DonneGaulois".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DonneGaulois)localhost.lesgaulois.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
